...
WebUI.setText(findTestObject('Landing Page/Register Modal/input_Full name_fullName'), 'Fa')
...
WebUI.setText(findTestObject('Landing Page/Register Modal/input_Full name_fullName'), 'falditest12392837465298734652834562839475643329874563487562398745')
