...
WebUI.setText(findTestObject('Landing Page/Register Modal/input_Password_password'), 'test123')
...
WebUI.setText(findTestObject('Landing Page/Register Modal/input_Password_password'), 'test1234')
...
WebUI.setText(findTestObject('Landing Page/Register Modal/input_Password_password'), 'Test1234!345760349586703498576566')
